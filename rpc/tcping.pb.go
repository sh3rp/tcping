...
func (*Empty) Descriptor() ([]byte, []int) {
	return fileDescriptor_f69eb27845da57d9, []int{0}
}
...
func (*Probe) Descriptor() ([]byte, []int) {
	return fileDescriptor_f69eb27845da57d9, []int{1}
}
...
func (*Probes) Descriptor() ([]byte, []int) {
	return fileDescriptor_f69eb27845da57d9, []int{2}
}
...
func (*ProbeSchedule) Descriptor() ([]byte, []int) {
	return fileDescriptor_f69eb27845da57d9, []int{3}
}
...
func (m *ProbeSchedule) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProbeSchedule.Merge(m, src)
}
...
func (*ProbeSchedules) Descriptor() ([]byte, []int) {
	return fileDescriptor_f69eb27845da57d9, []int{4}
}
...
func (m *ProbeSchedules) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProbeSchedules.Merge(m, src)
}
...
func (*ProbeQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_f69eb27845da57d9, []int{5}
}
...
func (m *ProbeQuery) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProbeQuery.Merge(m, src)
}
...
func (*ProbeQueryResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_f69eb27845da57d9, []int{6}
}
...
func (m *ProbeQueryResult) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProbeQueryResult.Merge(m, src)
}
...
func (*ProbeQueryResults) Descriptor() ([]byte, []int) {
	return fileDescriptor_f69eb27845da57d9, []int{7}
}
...
func (m *ProbeQueryResults) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProbeQueryResults.Merge(m, src)
}
...
func init() { proto.RegisterFile("tcping.proto", fileDescriptor_f69eb27845da57d9) }

var fileDescriptor_f69eb27845da57d9 = []byte{
